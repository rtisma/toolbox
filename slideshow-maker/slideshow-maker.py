...
def build_parser() -> argparse.ArgumentParser:
    ...
    p_annotate.add_argument("-F", "--date-format", default="%Y-%m-%d %H:%M", help="strftime format for the mtime fallback")
    ...
    p_render.add_argument("-F", "--date-format", default="%Y-%m-%d %H:%M", help="strftime format for the mtime fallback (only used with --annotate)")
